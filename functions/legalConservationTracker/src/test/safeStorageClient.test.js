...
describe('Prepare MockServer on port ' + port, () => {
    ...
    describe('update Tag Url Test ' + port, () => {
        it('update Tag  200 OK', async () => {
            ...
            mockServer.forPost(`/v1/files/${fileKey}/tags`).thenReply(200)
            const res = await putUpdateTags(fileKey, body);
        ...
        it('update Tag 400 Bad request', async () => {
            ...
            mockServer.forPost(`/v1/files/${fileKey}/tags`).thenReply(400, 'Bad request')
